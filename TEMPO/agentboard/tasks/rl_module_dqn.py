...
class AutoToolRLAgent:
    """DQN-based RL agent — NO pre-trained weights loaded (fresh start)."""
    def __init__(self, state_dim=4, action_dim=3, lr=0.001, gamma=0.9,
                 epsilon=0.3, epsilon_min=0.05, epsilon_decay=0.9990):
        ...
        self.batch_size = 64
        print("🤖 [RL-DQN] Fresh start — no pre-trained weights loaded.", flush=True)
