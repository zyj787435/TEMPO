...
# Derive project root from this file location when PROJECT_PATH is not provided.
DEFAULT_PROJECT_PATH = str(Path(__file__).resolve().parent.parent)
os.environ.setdefault("PROJECT_PATH", DEFAULT_PROJECT_PATH)
...
def main():
    ...
    for task_name in task_names:
        ...
        # 关键修复：将task_name传入agent配置，确保agent使用正确的工具描述和解析器
